...
//attributeValues eg:spec.#user.#userName: interface
type UpdateFunc func(input runtime.Object, attributeValues map[string]interface{}) (output runtime.Object, ttl *uint64, err error)
