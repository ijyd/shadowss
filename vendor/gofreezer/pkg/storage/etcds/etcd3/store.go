...
import (
	...
	"gofreezer/pkg/storage/etcds/etcd"
	"gofreezer/pkg/watch"
...
func New(c *clientv3.Client, codec runtime.Codec, prefix string) *store {
...
func (s *store) GuaranteedUpdate(
	...
	precondtions *storage.Preconditions, tryUpdate etcds.UpdateFunc, suggestion ...runtime.Object) error {
	v, err := conversion.EnforcePtr(out)
	if err != nil {
		panic("unable to convert output object to pointer")
	}
...
func (s *store) updateState(st *objState, userUpdate etcds.UpdateFunc) (runtime.Object, uint64, error) {
