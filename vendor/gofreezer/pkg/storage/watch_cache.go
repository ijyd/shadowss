...
import (
	...
	//"gofreezer/pkg/client/cache"
	"gofreezer/pkg/runtime"
	"gofreezer/pkg/util/clock"
	"gofreezer/pkg/watch"
)
...
func (w *watchCache) Add(obj interface{}) error {
	...
	//seachann delete
	f := func(obj runtime.Object) error { return nil /*return w.store.Add(obj)*/ }
...
func (w *watchCache) Update(obj interface{}) error {
	...
	//seanchann delete
	f := func(obj runtime.Object) error { return nil /*return w.store.Update(obj) */ }
	return w.processEvent(event, resourceVersion, f)
}
...
func (w *watchCache) Delete(obj interface{}) error {
	...
	//seanchann delete
	f := func(obj runtime.Object) error { return nil /*return w.store.Delete(obj) */ }
	return w.processEvent(event, resourceVersion, f)
}
...
func (w *watchCache) WaitUntilFreshAndList(resourceVersion uint64) ([]interface{}, uint64, error) {
	...
	//seanchann delete
	return nil, w.resourceVersion, nil
}
