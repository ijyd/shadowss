...
import (
	...
	storage "gofreezer/pkg/storage/mongodbs"
...
func PutLoginUser(request *restful.Request, response *restful.Response) {
	...
	// 	QueryArgs: name,
	// }
	var outObj *apiext.Login
	err = StorageCodec.GuaranteedUpdate(ctx, name, login, true, nil, func(input runtime.Object) (output runtime.Object, ttl *uint64, err error) {
	...
	output, err = runtime.Encode(GenericStorage.Codecs, outObj)
	if err != nil {
