...
import (
	...
	"gofreezer/cmd/libs/go2idl/set-gen/generators"
...
func main() {
	...
	// locations.
	arguments.InputDirs = []string{"gofreezer/pkg/util/sets/types"}
	arguments.OutputPackagePath = "gofreezer/pkg/util/sets"
