...
import (
	...
	"gofreezer/cmd/libs/go2idl/generator"
	"gofreezer/cmd/libs/go2idl/namer"
	"gofreezer/cmd/libs/go2idl/parser"
	"gofreezer/cmd/libs/go2idl/types"
...
func New() *Generator {
	...
	common := args.GeneratorArgs{
		...
		GoHeaderFilePath: filepath.Join(sourceTree, "gofreezer/hack/boilerplate/boilerplate.go.txt"),
	}
	...
	return &Generator{
		...
		Packages: strings.Join([]string{
			...
			`+gofreezer/pkg/watch/versioned`,
			`gofreezer/pkg/api/unversioned`,
			`gofreezer/pkg/api/v1`,
			`gofreezer/pkg/apis/policy/v1alpha1`,
			`gofreezer/pkg/apis/extensions/v1beta1`,
			`gofreezer/pkg/apis/autoscaling/v1`,
			`gofreezer/pkg/apis/authorization/v1beta1`,
			`gofreezer/pkg/apis/batch/v1`,
			`gofreezer/pkg/apis/batch/v2alpha1`,
			`gofreezer/pkg/apis/apps/v1alpha1`,
			`gofreezer/pkg/apis/authentication/v1beta1`,
			`gofreezer/pkg/apis/rbac/v1alpha1`,
			`gofreezer/federation/apis/federation/v1beta1`,
			`gofreezer/pkg/apis/certificates/v1alpha1`,
			`gofreezer/pkg/apis/imagepolicy/v1alpha1`,
			`gofreezer/pkg/apis/storage/v1beta1`,
		}, ","),
		DropEmbeddedFields: "gofreezer/pkg/api/unversioned.TypeMeta",
	}
}
