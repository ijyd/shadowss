...
import (
	...
	"gofreezer/cmd/libs/go2idl/client-gen/generators/normalization"
...
func (g *genGroup) GenerateType(c *generator.Context, t *types.Type, w io.Writer) error {
	...
	const pkgRESTClient = "gofreezer/pkg/client/restclient"
	const pkgRegistered = "gofreezer/pkg/apimachinery/registered"
	const pkgAPI = "gofreezer/pkg/api"
	const pkgSerializer = "gofreezer/pkg/runtime/serializer"
