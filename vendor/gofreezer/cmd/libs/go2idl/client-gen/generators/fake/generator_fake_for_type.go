...
func (g *genFakeForType) GenerateType(c *generator.Context, t *types.Type, w io.Writer) error {
	...
	const pkgTestingCore = "gofreezer/pkg/client/testing/core"
	...
	m := map[string]interface{}{
		...
		"watchInterface":       c.Universe.Type(types.Name{Package: "gofreezer/pkg/watch", Name: "Interface"}),
		"apiDeleteOptions":     c.Universe.Type(types.Name{Package: "gofreezer/pkg/api", Name: "DeleteOptions"}),
		"apiListOptions":       c.Universe.Type(types.Name{Package: "gofreezer/pkg/api", Name: "ListOptions"}),
		"GroupVersionResource": c.Universe.Type(types.Name{Package: "gofreezer/pkg/api/unversioned", Name: "GroupVersionResource"}),
		"PatchType":            c.Universe.Type(types.Name{Package: "gofreezer/pkg/api", Name: "PatchType"}),
		"Everything":           c.Universe.Function(types.Name{Package: "gofreezer/pkg/labels", Name: "Everything"}),
