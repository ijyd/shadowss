...
import (
	...
	"gofreezer/cmd/libs/go2idl/client-gen/test_apis/testgroup.k8s.io/v1"
	"gofreezer/pkg/api"
	"gofreezer/pkg/api/meta"
	"gofreezer/pkg/api/unversioned"
	"gofreezer/pkg/apimachinery"
	"gofreezer/pkg/apimachinery/registered"
	"gofreezer/pkg/runtime"
	"gofreezer/pkg/util/sets"
)

const importPrefix = "gofreezer/cmd/libs/go2idl/client-gen/test_apis/testgroup.k8s.io"
