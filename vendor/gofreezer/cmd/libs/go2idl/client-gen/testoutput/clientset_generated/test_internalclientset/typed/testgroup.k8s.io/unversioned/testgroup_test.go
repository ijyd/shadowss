...
import (
	...
	testgroup "gofreezer/cmd/libs/go2idl/client-gen/test_apis/testgroup.k8s.io"
	_ "gofreezer/cmd/libs/go2idl/client-gen/test_apis/testgroup.k8s.io/install"
	. "gofreezer/cmd/libs/go2idl/client-gen/testoutput/clientset_generated/test_internalclientset/typed/testgroup.k8s.io/unversioned"
	"gofreezer/pkg/api"
	"gofreezer/pkg/api/testapi"
	"gofreezer/pkg/api/unversioned"
	"gofreezer/pkg/apimachinery/registered"
	"gofreezer/pkg/client/restclient"
	"gofreezer/pkg/client/unversioned/testclient/simple"
