...
import (
	...
	clientgenargs "gofreezer/cmd/libs/go2idl/client-gen/args"
	"gofreezer/cmd/libs/go2idl/client-gen/generators"
...
var (
	...
	basePath               = flag.String("input-base", "gofreezer/pkg/apis", "base path to look for the api group. Default to \"gofreezer/pkg/apis\"")
	clientsetName          = flag.StringP("clientset-name", "n", "internalclientset", "the name of the generated clientset package.")
	clientsetPath          = flag.String("clientset-path", "gofreezer/pkg/client/clientset_generated/", "the generated clientset will be output to <clientset-path>/<clientset-name>. Default to \"gofreezer/pkg/client/clientset_generated/\"")
...
func main() {
	...
	dependencies := []string{
		...
		"gofreezer/pkg/watch",
		"gofreezer/pkg/client/unversioned",
		"gofreezer/pkg/apimachinery/registered",
	}

	if *test {
		arguments.InputDirs = append(dependencies, []string{
			"gofreezer/cmd/libs/go2idl/client-gen/test_apis/testgroup.k8s.io",
		}...)
		arguments.CustomArgs = clientgenargs.Args{
			...
			GroupVersionToInputPath: map[unversioned.GroupVersion]string{
				unversioned.GroupVersion{Group: "testgroup.k8s.io", Version: ""}: "gofreezer/cmd/libs/go2idl/client-gen/test_apis/testgroup.k8s.io",
			},
			ClientsetName:       "test_internalclientset",
			ClientsetOutputPath: "gofreezer/cmd/libs/go2idl/client-gen/testoutput/clientset_generated/",
			ClientsetOnly:       false,
			FakeClient:          true,
			CmdArgs:             cmdArgs,
		}
