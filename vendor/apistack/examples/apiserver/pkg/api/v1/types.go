...
type UserTokenSpec struct {
	ID         int64            `json:"id,omitempty" freezer:"column:id" gorm:"column:id"`
	Token      string           `json:"token,omitempty" freezer:"column:token;resoucekey" gorm:"column:token"`
	...
	Name       string           `json:"name,omitempty" freezer:"column:name" gorm:"column:name"`
}
