...
func NewStore(store registry.Store) *Store {
	return &Store{
		Store:   store,
		Storage: store.Storage.(awsdynamodb.Interface),
	}
}
...
func (e *Store) Create(ctx api.Context, obj runtime.Object) (runtime.Object, error) {
	...
	if err := e.Storage.Create(ctx, key, obj, out, ttl); err != nil {
		...
		if accessor.GetDeletionTimestamp() != nil {
			msg := &err.(*apierr.StatusError).ErrStatus.Message
...
func (e *Store) Update(ctx api.Context, name string, objInfo rest.UpdatedObjectInfo) (runtime.Object, bool, error) {
	...
	err = e.Storage.GuaranteedUpdate(ctx, key, out, true, storagePreconditions, func(existing runtime.Object, attributeValues map[string]interface{}) (runtime.Object, *uint64, error) {
		...
		//we not used version for dynamodb backend
		...
		// 	return nil, nil, apierr.NewInvalid(qualifiedKind, name, fieldErrList)
		// }
		// if newVersion != version {
		// 	return nil, nil, apierr.NewConflict(e.QualifiedResource, name, fmt.Errorf(OptimisticLockErrorMsg))
		// }
...
// 		etcds.SimpleUpdate(func(existing runtime.Object) (runtime.Object, error) {
