...
import (
	...
	clientset "apistack/pkg/client/clientset_generated/internalclientset"
	"apistack/pkg/client/restclient"
	"apistack/pkg/util/config"
...
func NewServerRunOptions() *ServerRunOptions {
	return &ServerRunOptions{
		...
		CertDirectory:                            "/var/run/apistack",
...
func (s *ServerRunOptions) AddUniversalFlags(fs *pflag.FlagSet) {
	...
	fs.StringVar(&s.CertDirectory, "cert-dir", s.CertDirectory, ""+
		"The directory where the TLS certs are located (by default /var/run/apistack). "+
	...
	fs.StringVar(&s.TLSCertFile, "tls-cert-file", s.TLSCertFile, ""+
		...
		"are generated for the public address and saved to /var/run/apistack.")
